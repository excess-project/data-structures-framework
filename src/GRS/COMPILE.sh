...
nvcc -O3 -m64 -c -g SpGEMM_variant_bhSPARSE_cuda.cpp $BHSPARSE_DIR/{bhsparse.cpp,bhsparse_cuda.cu} -I $CUDA_DIR/include/ -I ../SpBLAS -I ../include -I $GRS_DIR -I $BHSPARSE_DIR -I $CUDA_DIR/samples/common/inc -I . && \
